<template>
  <van-action-sheet v-model="show2" title="Terms & Conditions" style="background-color: #232026; color:white; height: 70%;">
    <div class="terms">
        ...
        <span class="s1"
            ...
            revise the resources usage policy in any moment.</span
        >
        </p>
        <p class="p9">
        <br />
        ...
        <span class="s1">
            ...
            license to download, install and use our service strictly in accordance
            with the terms of this Agreement.
            <br />
            <br />
            These Terms &amp; Conditions are a contract between you and
            <a>Cafeteria</a>
            (referred to in these Terms &amp; Conditions as "<a>Cafeteria</a>",
            "us", "we" or "our"), the provider of the
            <a>Cafeteria</a>
            website and the services accessible from the
            <a>Cafeteria</a>
            website (which are collectively referred to in these Terms &amp;
            Conditions as the "<a>Cafeteria</a>
            Service").
            <br />
            <br />
            ...
            Terms &amp; Conditions, we reserve the right to cancel your account or
            block access to your account without notice.</span
        >
        </p>
        <p class="p6">
        <br />
        ...
        <p class="p8">
        <span class="s1">For this Terms &amp; Conditions:</span>
        </p>
        <p class="p9">
        <br />
        </p>
        ...
        <li class="li8">
            ...
            to
            <a>Cafeteria</a>
            that is responsible for your information under this Privacy Policy.<br
            /></span>
        </li>
        <li class="li8">
            <span class="s1">
        ...
        <li class="li8">
            ...
            other device that can be used to visit
            <a>Cafeteria</a>
            and use the services.<br
            /></span>
        </li>
        <li class="li8">
            <span class="s1">
            ...
            location from which a device is connecting to the Internet.<br
            /></span>
        </li>
        <li class="li8">
            <span class="s1">
        ...
        <li class="li8">
            ...
            services we think may interest you.<br
            /></span>
        </li>
        <li class="li8">
            <span class="s1">
            <strong>Website:</strong>
            <a>Cafeteria</a>’s site, which can be accessed via this URL:
            <a>https://cacoffe.herokuapp.com/.</a>
            <br
            /></span>
        </li>
        <li class="li8">
        ...
        <li class="li11">
            ...
            or the licensors of the service.</span
            >
        </li>
        </ul>
        <p class="p3">
        ...
        <span class="s1"
            ...
            you and us for the Service until we accept your order by a confirmatory
        ...
        <span class="s1"
            ...
            discuss any of the issues you are going through with our product.</span
        >
        </p>
        <p class="p3">
        <br />
        ...
        <span class="s1"
            ...
            purchase, you hereby consent to our Terms &amp; Conditions.</span
        >
        </p>
        <p class="p3">
        <br />
        ...
        <span class="s1"
            ...
            no responsibility for the content, Terms &amp; Conditions or practices
            of any third party sites or services.</span
        >
        </p>
        <p class="p3">
        <br />
        ...
        <span class="s1"
            ...
            update the Terms &amp; Conditions modification date below.</span
        >
        </p>
        <p class="p3">
        <br />
        ...
        <span class="s1"
            ...
            without notice and without liability to you.</span
        >
        </p>
        <p class="p3">
        <br />
        ...
        <span class="s1"
            ...
            authorized to act on behalf of the owner.</span
        >
        </p>
        <p class="p3">
        <br />
        ...
        <span class="s1"
            ...
            free or that any errors or defects can or will be corrected.<br />
            <br />
        ...
        <span class="s1"
            ...
            ACCRUES. OTHERWISE, SUCH CAUSE OF ACTION IS PERMANENTLY BARRED.</span
        >
        </p>
        <p class="p3">
        <br />
        ...
        <span class="s1"
            ...
            constitute waiver of any subsequent breach.<br />
            <br />
            ...
            terms, the terms of this Agreement shall govern.</span
        >
        </p>
        <p class="p3">
        <br />
        ...
        <span class="s1"
            ...
            time of such use or purchase.</span
        >
        </p>
        <p class="p3">
        <br />
        ...
        <span class="s1"
            ...
            of the material is prohibited.</span
        >
        </p>
        <p class="p3">
        <br />
        ...
        <span class="s1"
            ...
            ENFORCEMENT OR VALIDITY OF YOUR OR Cafeteria’s INTELLECTUAL PROPERTY
            RIGHTS. The term “dispute” means any dispute, action, or other
            controversy between you and us concerning the Services or this
        ...
        <span class="s1"
            ...
            is sent. After sixty (60) days, you or us may commence
            arbitration.</span
        >
        </p>
        <p class="p3">
        ...
        <span class="s1"
            ...
            shall be borne by the non-prevailing party.</span
        >
        </p>
        <p class="p3">
        <br />
        ...
        <span class="s1"
            ...
            or with incorrect information due to typographical error, we shall have
            the right to refuse or cancel any orders placed for the product and/ or
        ...
        <span class="s1"
            ...
            representative of us. We will be entitled to injunctive or other
            equitable relief (without the obligations of posting any bond or surety)
            in the event of any breach or anticipatory breach by you. We operate and
            control our Service from our offices in . The Service is not intended
        ...
        <span class="s1"
            ...
            Service at any time without prior notice.<br />
            <br />
